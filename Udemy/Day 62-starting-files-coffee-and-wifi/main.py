...
class CafeForm(FlaskForm):
    ...
    close_time = StringField('Close time e.g 7 pm', validators=[DataRequired()])
    coffee = SelectField('Coffee rating', choices=['☕️', '☕️☕️', '☕️☕️☕️', '☕️☕️☕️☕️', '☕️☕️☕️☕️☕️']
                                                    ,validators=[DataRequired()])
    wifi = SelectField('Wi-Fi quality', choices=['✘', '💪', '💪💪',  '💪💪💪',
                                                 '💪💪💪💪', '💪💪💪💪💪️'], validators=[DataRequired()])
    power = SelectField('Power availability', choices=['✘',  '🔌', '🔌🔌','🔌🔌🔌️',  '🔌🔌🔌🔌',  '🔌🔌🔌🔌🔌️']
                        ,validators=[DataRequired()])
    ...
    # Make the form write a new row into cafe-data.csv
        with open("cafe-data.csv", mode="a", encoding='utf-8') as file:
            file.write(f"\n{form.cafe.data},"
                           ...
                           f"{form.wifi.data},"
                           f"{form.power.data}")
        # after the data is added to the csv, it redirects back to the cafe.html
